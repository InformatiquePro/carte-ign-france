...
*Note : le script pour Manjaro Linux, il , n'est pas capable de détecter d'autre distribution linux basé sur Arch Linux, Arch Linux inclus. Noter qu'il est encore perfectible et être adapté à toute les distribution basé sur Arch Linux.**
