...
*Note : seul le scripte debian/ubuntu permet, pour l'instant de télécharger les cartes du Morbihan (56) **ET** de Paris (75)*
...
*Note : le script pour Arch Linux, je l'ai uniquement testé sur **Manjaro Linux** et il est encore perfectible car il ne réussi pas à détecter si QGIS ou p7zip sont déja installer**
